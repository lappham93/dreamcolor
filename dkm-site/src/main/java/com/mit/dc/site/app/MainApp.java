...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        handler.addServletWithMapping(HomeHandler.class, "/web/dkm");
        handler.addServletWithMapping(ContactHandler.class, "/web/dkm/contact");
        handler.addServletWithMapping(AboutUsHandler.class, "/web/dkm/aboutus");
        handler.addServletWithMapping(ColorChartHandler.class, "/web/dkm/colorchart");
        ...
        //static file
        ContextHandler resource_handler = new ContextHandler("/web/dkm/static");
