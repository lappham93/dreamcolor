...
import com.mit.photodb.handler.TMPhotoHandler;
...
public class MTServer {
    private final Logger logger = LoggerFactory.getLogger(MTServer.class);
    
    public boolean setupAndStart() {
        ThriftServers servers = new ThriftServers("mphoto");
        MPhotoService.Processor processor = new MPhotoService.Processor(TMPhotoHandler.getInstance());
