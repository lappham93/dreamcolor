...
public class SearchResultServlet extends ServletWrapper {
	private final List<String> paramRequire = Arrays.asList("code", "page", "count");
	...
	protected void doProcess(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if (params != null && checkEmptyParameter(params, paramRequire)) {
			try {
				...
				Map<String, Object> rs = ColorModel.Instance.searchColor(code, count, from);
