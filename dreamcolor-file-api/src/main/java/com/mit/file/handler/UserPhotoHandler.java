 ...
 * @since Jan 19, 2016
 */
public class UserPhotoHandler extends HandlerWrapper {
	...
	public void handle(String target, Request baseRequest,
        ...
        String uri = "/cyog/load/user/photo";
		if (target.startsWith(uri)) {
            ...
            if(p != null && !p.isEmpty()){
                ...
                if(tptrs != null && tptrs.error >= 0 && tptrs.value != null){
                    ...
                    logger.info("UserPhotoHandler load from rockdb - pid: " + p + " Size: " + size + " FileSize: " + FileUtils.byteCountToDisplaySize(data.length));
                    if(data != null && size > 0){
                    ...
                    logger.info("UserPhotoHandler after resizeImage - pid: " + p + " Size: " + size + " FileSize: " + FileUtils.byteCountToDisplaySize(fileZise));
                    ...
                    logger.info("UserPhotoHandler load from rockdb - pid: " + p + " Size: " + size + " -------> NULL ");
            ...
            logger.info("UserPhotoHandler - pid: " + p + " Size: " + size + " FileSize: " + FileUtils.byteCountToDisplaySize(fileZise) + " Time: " + (System.nanoTime() - t) + "ns ");
        }
    }
