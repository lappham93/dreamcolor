 ...
 * @since Mar 4, 2016
 */
public class LoadDistributorPhotoServlet extends BaseHandler {
	private static Logger logger = LoggerFactory.getLogger(LoadDistributorPhotoServlet.class);

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
		try {
			renderDistributorPhoto(req, resp);
		} catch (Exception ex) {
	...
	private void renderDistributorPhoto(HttpServletRequest req, HttpServletResponse resp) {
		renderPhoto(req, resp, PhotoType.DISTRIBUTOR.getValue());
	}
}
