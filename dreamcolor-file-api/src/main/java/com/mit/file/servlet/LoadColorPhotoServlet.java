 ...
 * @since Mar 4, 2016
 */
public class LoadColorPhotoServlet extends BaseHandler {
	private static Logger logger = LoggerFactory.getLogger(LoadColorPhotoServlet.class);

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
		try {
			renderColorPhoto(req, resp);
		} catch (Exception ex) {
	...
	private void renderColorPhoto(HttpServletRequest req, HttpServletResponse resp) {
		renderPhoto(req, resp, PhotoType.COLOR.getValue());
	}
}
