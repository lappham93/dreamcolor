 ...
 * @since Mar 4, 2016
 */
public class LoadProductPhotoServlet extends BaseHandler {
	private static Logger logger = LoggerFactory.getLogger(LoadProductPhotoServlet.class);
	...
	private void renderProductPhoto(HttpServletRequest req, HttpServletResponse resp) {
		renderPhoto(req, resp, PhotoType.PRODUCT.getValue());
	}
}
