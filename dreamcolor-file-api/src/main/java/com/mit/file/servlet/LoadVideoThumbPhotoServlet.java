 ...
 * @since Mar 4, 2016
 */
public class LoadVideoThumbPhotoServlet extends BaseHandler {
	private static Logger logger = LoggerFactory.getLogger(LoadVideoThumbPhotoServlet.class);

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
		try {
			renderVideoThumbPhoto(req, resp);
		} catch (Exception ex) {
	...
	private void renderVideoThumbPhoto(HttpServletRequest req, HttpServletResponse resp) {
		renderPhoto(req, resp, PhotoType.VIDEO_THUMBNAIL.getValue());
	}
}
